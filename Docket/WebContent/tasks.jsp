<%@ page import="java.sql.*" %>
              ...
              <form id="add-event">
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="input-name" class="form-control" name="ename">
                  </div>
                  <div class="form-group">
                    <label>Event Date</label>
                    <input type='text' id="input-date" class="datetimepicker form-control" name="edate">
                  </div>
                  <div class="form-group">
  ...
  <% String db="planner" ; String table="tasks" ; String user="docket" ; String pass="!d0ckeT2t3" ; try {
    Class.forName("com.mysql.jdbc.Driver"); Connection
    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/"+db+"?autoReconnect=true&useSSL=false", user, pass);
