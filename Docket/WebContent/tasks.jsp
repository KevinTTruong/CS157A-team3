...
<div class="wrapper">
	...
	<body>
		<div class="calendar">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label>Notification</label> <select class="form-control"
										name="notif-type">
										<option value="email-notif">email</option>
										<option value="text-notif">text</option>
									</select>
								</div>
							</div>
							<div class="modal-footer">
			...
			String taskDate = request.getParameter("edate");
			String taskColor = request.getParameter("ecolor");
			String taskIcon = request.getParameter("eicon");
